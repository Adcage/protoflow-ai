...
Run this before finishing. P0 = must pass; P1 = should pass; P2 = nice to have.
...
- [ ] **Mobile reflow works.** All `grid-2`, `grid-3`, `grid-4`, `grid-2-1`, `grid-1-2` collapse to one column at ≤920px. Verify by mentally narrowing — no horizontal scroll.
