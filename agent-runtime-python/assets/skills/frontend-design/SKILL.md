...
4. Build production-grade frontend code.
   ...
   - For Vue projects, write real Vue SFC files and preserve the seed project structure.
   - Use file tools (`write_file`) to write real project files under the workspace; do not emit content wrapped in `<artifact>` tags.
