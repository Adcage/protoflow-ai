...
/** 此处后端没有提供注释 POST /user/edit/user/self */
export async function editUserSelf(body: API.UserEditRequest, options?: { [key: string]: any }) {
  return request<API.BaseResponseBoolean>('/user/edit/user/self', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
